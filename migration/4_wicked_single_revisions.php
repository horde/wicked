...
class WickedSingleRevisions extends Horde_Db_Migration_Base
{
    ...
    public function up()
    {
        ...
        $this->addColumn('wicked_pages', 'page_version', 'integer', ['null' => false, 'default' => 0]);
        $this->addColumn('wicked_history', 'page_version', 'integer', ['null' => false, 'default' => 0]);
        ...
        foreach ($history as $entry) {
            ...
            $this->update($pageQuery, [$version + 1, $entry['page_id']]);
            $id = $entry['page_id'];
            $version++;
        }
        $this->update('UPDATE wicked_pages SET page_version = 1 WHERE page_version = 0');

        $this->addPrimaryKey('wicked_history', ['page_id', 'page_version']);
        ...
        $this->addColumn('wicked_attachments', 'attachment_version', 'integer', ['null' => false, 'default' => 0]);
        $this->addColumn('wicked_attachment_history', 'attachment_version', 'integer', ['null' => false, 'default' => 0]);
        ...
        foreach ($attachments as $attachment) {
            $version = $this->selectValue(
                $query,
                [$attachment['page_id'], $attachment['attachment_name']]
            );
            if ($version === false) {
                $version = 1;
            } else {
        ...
        $this->addPrimaryKey(
            ...
            ['page_id', 'attachment_name', 'attachment_version']
        );
    ...
    {
        /* Pages */
        $this->addColumn('wicked_pages', 'page_majorversion', 'integer', ['null' => false, 'default' => 0]);
        $this->addColumn('wicked_pages', 'page_minorversion', 'integer', ['null' => false, 'default' => 0]);
        ...
        $this->removePrimaryKey('wicked_history');
        $this->addColumn('wicked_history', 'page_majorversion', 'integer', ['null' => false, 'default' => 0]);
        $this->addColumn('wicked_history', 'page_minorversion', 'integer', ['null' => false, 'default' => 0]);
        ...
        $this->addPrimaryKey('wicked_history', ['page_id', 'page_majorversion', 'page_minorversion']);
        ...
        $this->addColumn('wicked_attachments', 'attachment_majorversion', 'integer', ['null' => false, 'default' => 0]);
        $this->addColumn('wicked_attachments', 'attachment_minorversion', 'integer', ['null' => false, 'default' => 0]);
        ...
        $this->removePrimaryKey('wicked_attachment_history');
        $this->addColumn('wicked_attachment_history', 'attachment_majorversion', 'integer', ['null' => false, 'default' => 0]);
        $this->addColumn('wicked_attachment_history', 'attachment_minorversion', 'integer', ['null' => false, 'default' => 0]);
        ...
        $this->addPrimaryKey('wicked_attachment_history', ['page_id', 'attachment_name', 'attachment_majorversion', 'attachment_minorversion']);
    }
