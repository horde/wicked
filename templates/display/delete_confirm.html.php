<form method="post" name="deleteform" action="<?php echo $this->h($this->formAction) ?>">
...
<h1 class="header">
 <?php echo _("Delete Page") ?>: <a href="<?php echo $this->h($this->pageUrl) ?>"><?php echo $this->h($this->pageName) ?></a>
